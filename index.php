  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><img src="dist/img/pln.jpg" class="img-square" width="25px" alt="User Image"><b>   PLN</b>APD</span>
      </a>
   ...
   <section class="content-header">
    ...
    <section class="content">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><i class="fa fa-inbox"></i> New
                  ...
                  <li><a href="?p=dashboard2"><i class="fa fa-envelope-o"></i> Project <span class="label label-success pull-right">13</span></a></li>
                  <li><a href="?p=dashboard"><i class="fa fa-file-text-o"></i> Rutin</a></li>
                  <li><a href="#"><i class="fa fa-filter"></i> Finish <span class="label label-warning pull-right">65</span></a>
                  </li>
                  <li><a href="#"><i class="fa fa-trash-o"></i> Fail</a></li>
                </ul>
              </div>
              <!-- /.box-body -->
            </div>
     ...
     <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2017 <a href="http://almsaeedstudio.com">TIM IT UIN Maulana Malik Ibrahim Malang</a>.</strong> All rights
      reserved.
    </footer>
